      ...
      Expanded(
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (currentDate.isBefore(DateTime.parse(reminder['timeToRemind']))) {
              return Card(
                child: ListTile(
                  ...
                  title: Text(reminder['plantName'], style: const TextStyle(fontWeight: FontWeight.bold)),
                  subtitle: Text(reminder['timeToRemind']),
                  trailing: Text(reminder['repeat'].toString() == "true" ? "Everyday" : "Once"),
                  onTap: () {
                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(
            ...
            return Card(
                child: ListTile(
              leading: Icon(Icons.eco, color: Colors.grey[500]),
